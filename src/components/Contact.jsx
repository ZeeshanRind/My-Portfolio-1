...
const Contact = () => {
  return (
    <div className='w-full lg:h-screen py-6 px-4 bg-slate-50'>
      <div  className='lg:max-w-[1240px] flex flex-col justify-center items-center sm:px-[30px] mx-auto'>

        <h1 className='md:text-5xl sm:text-4xl text-3xl font-bold md:py-2 mt-[30px] text-center'>Contact <span className='text-[#00df9a]'>Me!</span></h1>
         ...
         <form className="w-full max-w-[750px]">
             <div className="flex flex-wrap flex-col -mx-3 mb-6">
              ...
              <textarea id="message" rows="9" class="block p-2.5 mt-2 w-full rounded" placeholder="Your Message..."></textarea>
              <button className='bg-[#00df9a] w-[150px] rounded-full text-white font-medium mx-auto my-4 py-2'>Send Message</button>
             </div>
         </form>
      </div>
    </div>
